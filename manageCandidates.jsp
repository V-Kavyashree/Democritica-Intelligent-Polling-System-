...
<body>
    ...
    <form action="manageCandidates.jsp" method="get">
        <button type="submit" class="button" name="viewCandidates">View All Candidates</button>
    </form>

    <!-- Button to add new candidate -->
    <form action="addCandidate.jsp" method="get">
        <button type="submit" class="button" name="addCandidate">Add New Candidate</button>
    </form>

    <div>
        <% 
            // Check if the 'viewCandidates' button was clicked
            String viewCandidates = request.getParameter("viewCandidates");
